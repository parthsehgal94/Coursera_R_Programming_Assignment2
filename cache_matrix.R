## Here a special matrix is created using makeCacheMatrix 
## whose inverse is obtained and cached for future use

## Using <<- operator Im saving my special matrix in global env. 
